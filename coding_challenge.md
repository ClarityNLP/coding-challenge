...
The front-end should ideally be a single page app (preferably React) with a single `index.html`
...
[Guidelines can be found here](https://github.com/ClarityNLP/coding-challenge/blob/master/README.md)
